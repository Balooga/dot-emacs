...
* Setup Languagetool
#+BEGIN_SRC emacs-lisp
(setq-default langtool-language-tool-jar (cond
                                          ((file-exists-p "~/.emacs.d/site/languagetool-commandline.jar")
                                           "~/.emacs.d/site/languagetool-commandline.jar")
                                          ((file-exists-p "/usr/local/Cellar/languagetool/3.5/libexec/languagetool-commandline.jar")
                                           "/usr/local/Cellar/languagetool/3.5/libexec/languagetool-commandline.jar")
                                          (t nil)))
;; (setq-default langtool-java-classpath (cond
;;                                        ((file-exists-p "~/.emacs.d/site/languagetool-commandline.jar")
;;                                         "~/.emacs.d/site/*") 
;;                                        (t nil)))
#+END_SRC
...
(use-package flyspell
  ...
  (use-package langtool
    ...
    :config
    (setq-default
     ;; langtool-language-tool-jar (or (and gnu/linux-p
     ;;                                     (file-exists-p "~/.emacs.d/site/languagetool-commandline.jar"))
     ;;                                (and osx-p
     ;;                                     (file-exists-p ;; ;;"/usr/local/Cellar/languagetool/3.5/libexec/languagetool-commandline.jar")))
...
(use-package diff-hl
  :if (and (display-graphic-p) (or osx-p gnu/linux-p)) ;;Broken windows  
  :ensure t
  :defer t
  :init
...
(use-package org
  ...
  (setq org-src-tab-acts-natively t)    ; 't' makes tab behave like it
...
(use-package wttrin
  ...
  :defer t
  :config
  (add-to-list 'wttrin-default-cities "Burbank")
  ...
  (setq-default wttrin-default-accept-language '("Accept-Language" . "en-US,en;q=0.8")))
